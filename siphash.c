...
void
siphash128_init(struct siphash *s, const void *key)
{
...
void
siphash128_update(struct siphash *s, const void *buf, size_t len)
{
    uint64_t v0 = s->v0;
    uint64_t v1 = s->v1;
    uint64_t v2 = s->v2;
...
void
siphash128_final(const struct siphash *s, void *digest)
{
    uint64_t v0 = s->v0;
    uint64_t v1 = s->v1;
    uint64_t v2 = s->v2;
